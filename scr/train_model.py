...
# Обучаем модель
model = RandomForestClassifier(n_estimators=200, max_depth=None, min_samples_split=10, min_samples_leaf=5, bootstrap=True, class_weight='balanced', random_state=42)
